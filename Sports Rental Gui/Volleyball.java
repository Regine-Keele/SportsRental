...
public class Volleyball extends Rental_Service
{
    ...
    private static JSpinner Net_num = new JSpinner(model1);
    ...
    private static JCheckBox Net = new JCheckBox("Net --- ₱100",false);
    private static JCheckBox Ball = new JCheckBox("Ball--- ₱100",false);
    ...
    public static void Equipment_Menu(ActionEvent e){
        ...
        sport_frame.setTitle("VolleyBall Equipment");
        
        Top_Panel.setLayout(new GridLayout(1,2));
        Top_Panel.setBorder(new TitledBorder("VolleyBall Equipment"));
    ...
    public static void Order_summary(ActionEvent e){
            int Net_val = (Integer) Net_num.getValue();
            int Ball_val = (Integer) Ball_num.getValue();
            int Court_val = (Integer) Court_num.getValue();
            
            if(Net.isSelected()&& !Court.isSelected()&&!Ball.isSelected()){
                if(Net_val > 0){
                int price = 100;
                int val;
                val = price*Net_val;
                Order_Area.setText("");
                Order_Area.setText(Order+"\nVolleyball:\n"+"Net  --- "+Net_val+" for ₱ "+price+" each"+"\n");
                Rental_Service.total_val +=val;
            }   else{
                Order_Area.setText("Invalid Input");}}
            else if(!Net.isSelected()&& Court.isSelected()&&!Ball.isSelected()){
                if(Court_val>0){
                Order_Area.setText("");
                int price = 300;
                int val;
                ...
                if(Net_val>0&&Court_val>0){
                Order_Area.setText("");
                int price1 = 100;
                int price2 = 300;
                int val;
                val = (price1*Net_val)+(price2*Court_val);
                Order_Area.setText(Order+"\nVolleyball:\n"+"Net  --- "+Net_val+" for ₱ "+price1+" each"+"\n"
                +"Court --- "+Court_val+ " for ₱ " +price2+ " each");
                Rental_Service.total_val +=val;
            }   else{
                Order_Area.setText("Invalid Input");}}
            else if(Net.isSelected()&&!Court.isSelected()&&Ball.isSelected()){
                if(Net_val>0&&Ball_val>0){
                Order_Area.setText("");
                int price1 = 100;
                int price2 = 50;
                int val;
                val = (price1*Net_val)+(price2*Ball_val);
                Order_Area.setText(Order+"\nVolleyball:\n"+"Net  --- "+Net_val+" for ₱ "+price1+" each"+"\n"
                ...
                if(Net_val>0 && Court_val > 0&&Ball_val>0){
                int price1 = 100;
                int price2 = 50;
                int price3 = 300;
                int val;
                val = (price1*Net_val)+(price2*Ball_val)+(price3*Court_val);
                Order_Area.setText("");
                Order_Area.setText(Order+"\nVolleyball:\n"+"Net  --- "+Net_val+  " for ₱ "+price1+" each"+"\n"
                +"Ball ---"+Ball_num.getValue()+" for ₱ "+price2+" each"+"\n"
                +"Court ---"+Court_num.getValue()+" for ₱ "+price3+" each"+"\n");
                Rental_Service.total_val +=val;
            }   else{
                Order_Area.setText("Invalid Input");}}
            else{
